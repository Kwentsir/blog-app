...
RSpec.describe User, type: :model do
  ...
  it 'should get the last 3 posts' do
    ...
    Post.create(title: 'Second title', text: 'This is my second post', comments_counter: 0, likes_counter: 0,
                author: subject)
    Post.create(title: 'Third title', text: 'This is my third post', comments_counter: 0, likes_counter: 0,
                author: subject)
    Post.create(title: 'Fourth title', text: 'This is my fourth post', comments_counter: 0, likes_counter: 0,
                author: subject)
